 ...
 * @author Benhero
 */
public class L6_2_TextureRenderer extends BaseRenderer {
    ...
    private final FloatBuffer mVertexData2;
    ...
    private int mUniformMode;

    public L6_2_TextureRenderer(Context context) {
        super(context);
